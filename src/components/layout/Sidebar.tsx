...
const NAV_ITEMS = [
  ...
  { id: 'networth', label: 'Net Worth', icon: 'M12 8c-1.657 0-3 .672-3 1.5S10.343 11 12 11s3 .672 3 1.5S13.657 14 12 14m0-6V7m0 7v1m-7-3a9 9 0 1114 0A9 9 0 015 12z' },
  { id: 'income', label: 'Income Forecast', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  { id: 'rules', label: 'Transaction Rules', icon: 'M7 7h10M7 12h6m-6 5h10M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z' },
  { id: 'alerts', label: 'Alerts Inbox', icon: 'M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V4a2 2 0 10-4 0v1.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9' },
  { id: 'actions', label: 'Action Scheduler', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V9m-7 4l2 2 4-4' },
  { id: 'debt', label: 'Debt Planner', icon: 'M17 9V7a5 5 0 00-10 0v2M5 9h14l-1 10a2 2 0 01-2 2H8a2 2 0 01-2-2L5 9zm7 4v3m-2-1.5h4' },
  { id: 'cashflow', label: 'Cashflow Calendar', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  { id: 'goals', label: 'Savings Goals', icon: 'M12 8c-1.657 0-3 .672-3 1.5S10.343 11 12 11s3 .672 3 1.5S13.657 14 12 14m0-6V7m0 7v1m9-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  { id: 'recurring', label: 'Bills & Recurring', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
